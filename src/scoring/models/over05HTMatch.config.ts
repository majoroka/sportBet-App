    ...
    items: [
      {
        ...
        thresholds: [
          { at: 66, points: 40, status: 'good' },
          { at: 62, points: 35, status: 'good' },
          { at: 58, points: 30, status: 'good' },
          { at: 54, points: 24, status: 'warn' },
          { at: 50, points: 16, status: 'warn' },
          { at: 46, points: 8, status: 'warn' },
    ...
    items: [
      {
        ...
        thresholds: [
          { at: 68, points: 15, status: 'good' },
          { at: 62, points: 12, status: 'good' },
          { at: 56, points: 9, status: 'warn' },
          { at: 50, points: 6, status: 'warn' },
          { at: 44, points: 3, status: 'warn' },
          { at: 0, points: 0, status: 'bad' },
        ],
        formatValue: formatPercent0,
      },
      {
        ...
        thresholds: [
          { at: 1.15, points: 10, status: 'good' },
          { at: 0.95, points: 8, status: 'good' },
          { at: 0.78, points: 6, status: 'warn' },
          { at: 0.62, points: 3, status: 'warn' },
          { at: 0, points: 0, status: 'bad' },
        ],
    ...
    items: [
      {
        ...
        thresholds: [
          { at: 4.6, points: 12, status: 'good' },
          { at: 4.0, points: 10, status: 'good' },
          { at: 3.4, points: 7, status: 'warn' },
          { at: 2.8, points: 4, status: 'warn' },
          { at: 0, points: 0, status: 'bad' },
        ],
        formatValue: formatNumber2,
      },
      {
        ...
        thresholds: [
          { at: 6.2, points: 8, status: 'good' },
          { at: 5.4, points: 6, status: 'good' },
          { at: 4.6, points: 4, status: 'warn' },
          { at: 3.8, points: 2, status: 'warn' },
          { at: 0, points: 0, status: 'bad' },
        ],
        formatValue: formatNumber2,
      },
    ...
    items: [
      {
        ...
        thresholds: [
          { at: 3.0, points: 10, status: 'good' },
          { at: 2.7, points: 8, status: 'good' },
          { at: 2.4, points: 5, status: 'warn' },
          { at: 2.2, points: 2, status: 'warn' },
          { at: 0, points: 0, status: 'bad' },
        ],
        formatValue: formatNumber2,
      },
      {
        ...
        thresholds: [
          { at: 55, points: 5, status: 'good' },
          { at: 48, points: 3, status: 'warn' },
          { at: 0, points: 0, status: 'bad' },
        ],
        formatValue: formatPercent0,
      },
