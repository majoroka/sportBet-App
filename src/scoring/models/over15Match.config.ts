...
export const OVER_15_MATCH_LABEL = '+1.5 (Jogo)';
    ...
    items: [
      {
        ...
        thresholds: [
          { at: 71, points: 35, status: 'good' },
          { at: 67, points: 31, status: 'good' },
          { at: 63, points: 27, status: 'good' },
          { at: 59, points: 22, status: 'warn' },
          { at: 55, points: 16, status: 'warn' },
          { at: 51, points: 10, status: 'warn' },
    ...
    items: [
      {
        ...
        thresholds: [
          { at: 3.0, points: 20, status: 'good' },
          { at: 2.8, points: 17, status: 'good' },
          { at: 2.6, points: 13, status: 'warn' },
          { at: 2.4, points: 9, status: 'warn' },
          { at: 2.2, points: 5, status: 'warn' },
          { at: 0, points: 0, status: 'bad' },
        ],
    ...
    items: [
      {
        ...
        thresholds: [
          { at: 85, points: 10, status: 'good' },
          { at: 78, points: 8, status: 'good' },
          { at: 70, points: 6, status: 'warn' },
      ...
      },
      {
        ...
        thresholds: [
          { at: 1.8, points: 5, status: 'good' },
          { at: 1.5, points: 4, status: 'good' },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        thresholds: [
          { at: 1.05, points: 4, status: 'good' },
          { at: 0.85, points: 3, status: 'good' },
          { at: 0.65, points: 2, status: 'warn' },
          { at: 0, points: 0, status: 'bad' },
        ],
        formatValue: formatNumber2,
      },
