    ...
    items: [
      {
        ...
        thresholds: [
          { at: 62, points: 30, status: 'good' },
          { at: 58, points: 26, status: 'good' },
          { at: 54, points: 22, status: 'good' },
          { at: 50, points: 18, status: 'warn' },
          { at: 46, points: 12, status: 'warn' },
          { at: 42, points: 6, status: 'warn' },
    ...
    items: [
      {
        ...
        thresholds: [
          { at: 85, points: 6, status: 'good' },
          { at: 75, points: 4, status: 'warn' },
          { at: 65, points: 2, status: 'warn' },
          { at: 0, points: 0, status: 'bad' },
        ],
        formatValue: formatPercent0,
      },
    ...
    items: [
      {
        ...
        label: 'Casa % clean sheets (low é melhor)',
        maxPoints: 5,
        getValue: (input) => input.homeCleanSheetPct,
        thresholds: [
          { at: 20, points: 5, status: 'good' },
          { at: 30, points: 4, status: 'good' },
      ...
      },
      {
        ...
        label: 'Fora % clean sheets (low é melhor)',
        maxPoints: 5,
      ...
      },
      {
        ...
        thresholds: [
          { at: 1.4, points: 5, status: 'good' },
          { at: 1.1, points: 3, status: 'warn' },
          { at: 0.9, points: 1, status: 'warn' },
          { at: 0, points: 0, status: 'bad' },
        ],
        formatValue: formatNumber2,
      },
    ...
    items: [
      {
        ...
        thresholds: [
          { at: 58, points: 8, status: 'good' },
          { at: 52, points: 6, status: 'good' },
          { at: 46, points: 4, status: 'warn' },
          { at: 40, points: 2, status: 'warn' },
          { at: 0, points: 0, status: 'bad' },
        ],
        formatValue: formatPercent0,
      },
      {
        ...
        thresholds: [
          { at: 3.0, points: 7, status: 'good' },
          { at: 2.7, points: 5, status: 'good' },
          { at: 2.4, points: 3, status: 'warn' },
          { at: 2.1, points: 1, status: 'warn' },
          { at: 0, points: 0, status: 'bad' },
        ],
        formatValue: formatNumber2,
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        thresholds: [
          { at: 4.6, points: 4, status: 'good' },
          { at: 4.0, points: 3, status: 'good' },
          { at: 3.3, points: 1, status: 'warn' },
          { at: 0, points: 0, status: 'bad' },
        ],
        formatValue: formatNumber2,
      },
    ...
    items: [
      {
        ...
        thresholds: [
          { at: 40, points: 5, status: 'good' },
          { at: 80, points: 3, status: 'warn' },
          { at: 120, points: 1, status: 'warn' },
