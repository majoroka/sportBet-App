...
const teamToLeagueMap: Record<string, string> = {
  ...
  // Turquia
  'Galatasaray': 'Super Lig', 'Fenerbahçe': 'Super Lig', 'Fenerbahce': 'Super Lig', 'Trabzonspor': 'Super Lig', 'Besiktas': 'Super Lig', 'Basaksehir': 'Super Lig', 'Goztepe': 'Super Lig', 'Samsunspor': 'Super Lig', 'Alanyaspor': 'Super Lig', 'Gaziantep FK': 'Super Lig', 'Kasimpasa': 'Super Lig', 'Rizespor': 'Super Lig', 'Kocaelispor': 'Super Lig', 'Konyaspor': 'Super Lig', 'Kayseri': 'Super Lig', 'Gençlerbirligi': 'Super Lig', 'Eyupspor': 'Super Lig', 'Antalyaspor': 'Super Lig', 'Fatih Karagumruk': 'Super Lig',
  // Bélgica
